    ...
    <div className="relative min-h-screen bg-background">
      ...
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 pt-6">
        ...
        <nav className="text-sm">
          <Link to="/blog" className="px-3 py-2 text-muted-foreground hover:text-foreground">Blogg</Link>
          <Link to="/about" className="px-3 py-2 text-muted-foreground hover:text-foreground">Om</Link>
        </nav>
      </header>
      <main className="mx-auto max-w-6xl px-6 py-12">
        <h1 className="font-display text-4xl font-semibold tracking-tight sm:text-5xl">Live aktivitet</h1>
        <p className="mt-2 max-w-2xl text-muted-foreground">
          Hver bue viser en aktiv tilkobling til våre servere i Oslo. Oppdateres i sanntid via Supabase Realtime.
        </p>
        <div className="mt-8">
          <LiveWorldMap />
        </div>
